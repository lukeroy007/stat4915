...
Clustering reveals structure but isn't automatic proof of relationships
...
kmeans = KMeans(n_clusters=4, random_state=4915)
labels = kmeans.fit_predict(X)
